            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header iseng-sticky bg-white">
                        ...
                        <h4 class="ml-3">Form Tambah Produk</h4>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 px-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" id="deskripsi"  data-height="100">{{ old('deskripsi') }}</textarea>
                                    @error('deskripsi')
                                          <div class="text-danger small mt-1">{{ $message }}</div>
                                      @enderror
                                  </div>
