...
<section class="section">
    ...
    <section class="section-header ">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Create Tahun Pelajaran</div>
        </div>
    </section>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header iseng-sticky bg-white">
                        ...
                        <h4 class="ml-3">Form Tambah Tahun Pelajaran</h4>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body" >
                        <div class="row">
                            <div class="col-md-6 mx-auto">
                                <form method="POST" action="{{ route('tahunajaran.store') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tahun_ajaran" class="form-control @error('tahun_ajaran') is-invalid @enderror"  id="tahun_ajaran" value="{{ old('tahun_ajaran') }}"  placeholder="Contoh 2020/2021" autofocus>
                                        @error('tahun_ajaran')
