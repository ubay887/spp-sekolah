            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- /.card-row -->
                        <div class="row mt-5" style="min-height: 185px" v-if="dataSiswa">
                            {{-- info siswa --}}
                            <div class="col-md-2 mb-4">
                                <div class="user-item">
                                <img alt="image" height="128px" width="128px" :src="'../img/siswa/' + siswa.foto" class="img-fluid">
                                ...
                                <div id="accordion">
                                    <div class="accordion" v-for="(row, p) in tagihan">
                                        ...
                                        <div class="accordion-body collapse" :id="'panel-body-'+row.id" data-parent="#accordion" style="">
                                            <div class="row">
                                                <div class="" v-bind:class="{ 'col-md-8 col-12': row.jenis_pembayaran.tipe ==='bebas', 'col-md-4 col-6': row.jenis_pembayaran.tipe ==='bulanan' }" v-for="(oke, index) in row.tagihan_detail">
                                                    
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div v-if="row.jenis_pembayaran.tipe === 'bulanan'" class="small">
                                                                <strong>@{{ row.jenis_pembayaran.harga }}</strong> <br>
                                                                @{{oke.keterangan}}
                                                            </div>
                                                            <div v-else>
                                    ...
                                    <div class="card-body" >
                                        ...
                                        <div>
                                            ...
                                            <div v-else class="d-flex justify-content-center">
                                                <img alt="image" style="opacity: 0.3" height="90px" width="90px" src="../img/undraw_empty_cart_co35.png">
                                            </div>
                                        </div>
                        ...
                        <div class="row mt-1" style="min-height: 185px" v-else>
                ...
                <div class="modal-body">
                    <div>
                        <div class="d-flex justify-content-between">
                            ...
                            <span><strong>Tanggal : {{ date("d-m-Y") }}</strong></span>
                        </div>
                        <br>
