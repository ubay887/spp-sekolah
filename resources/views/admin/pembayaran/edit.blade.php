            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header iseng-sticky bg-white">
                        ...
                        <h4 class="ml-3">Form Edit Kelas</h4>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body" >
                        <div class="row">
                            <div class="col-md-6 mx-auto">
                                <form method="POST" action="{{ route('kelas.update', $kelas->id) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_kelas" class="form-control @error('nama_kelas') is-invalid @enderror"  id="nama_kelas" value="{{ $kelas->nama_kelas }}"  placeholder="Contoh: Kelas X.A" autofocus>
                                        @error('nama_kelas')
