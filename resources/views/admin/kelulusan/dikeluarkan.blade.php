            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header iseng-sticky bg-white">
                        <a href="{{ route('kelulusan.index')}}" class="btn">
                            <i class="fas fa-arrow-left  text-dark  "></i>
                        </a>
                        <h4>Data Siswa/i Dikeluarkan</h4>
                        <div class="card-header-action">
                            ...
                            <a href="{{ route('kelulusan.dikeluarkan') }}" class="badge badge-info" data-toggle="tooltip" data-placement="top" title=""
                                ...
                                <div class="pembayaranDetail">
                                    <div class="form-group ">
                                        ...
                                        <select name="status" id="status" class="form-control @error('status') is-invalid @enderror" required>
                                            ...
                                            <option value="Aktif" {{('Aktif' === old('status')) ? 'selected' : ''}}>Aktifkan Kembali</option>
