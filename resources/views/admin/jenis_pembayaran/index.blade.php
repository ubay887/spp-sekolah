                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('jenispembayaran.index') }}" method="GET">
                            ...
                            <div class="input-group input-group mb-3 float-right" style="width: 300px;">
                                ...
                                <div class="input-group-append">
                                    <a href="{{ route('jenispembayaran.index') }}" title="Refresh" class="btn btn-light"><i class="fas fa-circle-notch mt-2    "></i></a>
                                </div>
                            </div>
                        </form>
                                ...
                                <tbody>
                                    @forelse($jenis_pembayaran as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->nama_pembayaran }} {{$row->tagihan->count()}}</td>
                                            <td class="text-center">{{ $row->tahunajaran->tahun_ajaran }}</td>
                                            <td>{{ ($row->tipe === "bebas") ? 'Angsurang/Bebas' : 'Setiap Bulan' }}</td>
