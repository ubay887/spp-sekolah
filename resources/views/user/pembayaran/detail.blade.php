                ...
                <div class="card">
                    <div class="card-header iseng-sticky bg-white">
                        ...
                        <div class="card-header-action">
                            @if (!empty($detail->token) && $detail->status === "pending")
                            <a target="_blank" class="btn btn-secondary btn-icon" data-toggle="tooltip" data-placement="top" title=""
                            data-original-title="Cara Pembayaran"
                                href="https://app.sandbox.midtrans.com/snap/v1/transactions/{{$detail->token}}/pdf">
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="text-left">
                                    ...
                                    @if ($detail->status === "pending")
                                        ...
                                        <br>
                                        <span>
                                            Cara Pembayaran Bisa Dilihat <a target="_blank" class="" data-toggle="tooltip" data-placement="top" title=""
                                            data-original-title="Cara Pembayaran"
                                                href="https://app.sandbox.midtrans.com/snap/v1/transactions/{{$detail->token}}/pdf">
